...
const App = (props) => {
  ...
  const collapsedSidebarWidth = 60; // Width when sidebar is collapsed
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              width: isSidebarOpen
                ? `${sidebarWidth}px`
                : `${collapsedSidebarWidth}px`, // Handle collapsed state
          ...
          <div
            ...
            style={{
              ...
              marginLeft: isSidebarOpen
                ? `${sidebarWidth}px`
                : `${collapsedSidebarWidth}px`, // Adjust based on sidebar state
