...
const TemplateList = () => {
    ...
    const { interactiveTemplateArray, loading, error, pageSize, totalRecords, currentPage } = useSelector((state) => state.templates);
    ...
    const filteredSendernames = interactiveTemplateArray.filter((template) =>
