...
const DefinedTemplates = ({ isVisible, onClose }) => {
    ...
    return (
        <>
            {isVisible && (
                <div
                    className="absolute bottom-[1.5rem]  bg-white text-black shadow-2xl rounded-lg z-50"
                    style={{ minWidth: "350px", right: "-94px" }} // Set min width for the popup
                >
                    <div className="absolute top-2 border-b  border-black pr-2 text-end w-100 text-black cursor-pointer " onClick={onClose}>
                    ...
                    <div className="relative p-2 mt-10">
                        <input
                            ...
                            className="w-full  text-black pl-7 mb-1 py-1 rounded-md focus:outline-none"
                            value={searchQuery}
                        ...
                        {templates.length > 0 ? (
                            templates.map((option) => (
                                <div
                                    ...
                                    className={`px-4 py-2 hover:bg-slate-300 cursor-pointer text-sm ${selectedOption === option
                    ...
                    <div className="p-2 border-t text-end">
                        <button
                            className=" px-2 py-1 rounded-lg hover:bg-blue-600 disabled:bg-blue-600"
                            onClick={handleSend}
